...
INSERT IGNORE INTO `messagelog` (`Id`, `SendTime`, `ReceiveTime`, `StatusCode`, `StatusText`, `MessageTo`, `MessageFrom`, `MessageText`, `MessageType`, `MessageId`, `ErrorCode`, `ErrorText`, `Gateway`, `MessageParts`, `MessagePDU`, `Connector`, `UserId`, `UserInfo`) VALUES
...
-- Dumping data for table db_wup.messageout: ~0 rows (approximately)
/*!40000 ALTER TABLE `messageout` DISABLE KEYS */;
/*!40000 ALTER TABLE `messageout` ENABLE KEYS */;

-- Dumping data for table db_wup.tblannouncement: ~2 rows (approximately)
/*!40000 ALTER TABLE `tblannouncement` DISABLE KEYS */;
INSERT IGNORE INTO `tblannouncement` (`ANNOUNCEMENTID`, `ANNOUNCEMENT_TEXT`, `ANNOUNCEMENT_WHAT`, `ANNOUNCEMENT_WHEN`, `ANNOUNCEMENT_WHERE`, `DATEPOSTED`) VALUES
...
INSERT IGNORE INTO `tblautonumbers` (`AUTOID`, `AUTOSTART`, `AUTOEND`, `AUTOINC`, `AUTOKEY`) VALUES
	(10, '000', '27', 1, 'bookingid'),
	(12, '000', '62', 1, 'BLOGID');
/*!40000 ALTER TABLE `tblautonumbers` ENABLE KEYS */;

-- Dumping data for table db_wup.tblblogpost: ~6 rows (approximately)
/*!40000 ALTER TABLE `tblblogpost` DISABLE KEYS */;
INSERT IGNORE INTO `tblblogpost` (`BLOGID`, `BLOGS`, `BLOG_WHAT`, `BLOG_WHEN`, `BLOG_WHERE`, `DATEPOSTED`, `CATEGORY`, `AUTHOR`) VALUES
...
INSERT IGNORE INTO `tblcourse` (`COURSEID`, `COURSE`, `DESCRIPTION`) VALUES
...
INSERT IGNORE INTO `tbldepartment` (`DEPARTMENTID`, `DEPARTMENT`, `DESCRIPTION`) VALUES
...
-- Dumping data for table db_wup.tblevent: ~2 rows (approximately)
/*!40000 ALTER TABLE `tblevent` DISABLE KEYS */;
INSERT IGNORE INTO `tblevent` (`EVENTID`, `EVENT_TEXT`, `EVENT_WHAT`, `EVENT_WHEN`, `EVENT_WHERE`, `DATEPOSTED`) VALUES
...
INSERT IGNORE INTO `tblfaculty` (`INCID`, `IDNO`, `FNAME`, `MNAME`, `LNAME`, `DEPARTMENT`, `PHONE`, `PROIMAGE`, `FORGOTPASSWORD`) VALUES
	(9, '323232323', 'Augustus', 'Ceasar', 'Thirdy', '', '09182323232', NULL, NULL);
...
INSERT IGNORE INTO `tblstrand` (`STRANDID`, `STRAND`, `DESCRIPTION1`) VALUES
	(1, 'STEM', 'STEM'),
	(2, 'ABM', 'ABM'),
	(3, 'HUMSS', 'HUMSS'),
	(4, 'GAS', 'GAS');
...
INSERT IGNORE INTO `tblstudent` (`INCID`, `IDNO`, `FNAME`, `MNAME`, `LNAME`, `PHONE`, `DEPARTMENT`, `YLVL`, `SEC_BLOCK`, `COURSE`, `USERNAME`, `STUDPASS`, `PROIMAGE`, `FORGOTPASSAUTH`) VALUES
	(21, '612361263', 'August', 'Mana', 'Lona', '09090909090', '3', '4th Year', 'Block 3', '3', 'D3$LbrjPf7Tz', 'Fb!$8n', 'student_image/239997704_820843678622654_955177988405425248_n.jpg', NULL),
	(22, '6', 'Super Admin', '', '', '', '', '', '', '', 'SU', '3fda92826b531fc6ebf7e1f511e9605dd159e0e2', NULL, NULL);
/*!40000 ALTER TABLE `tblstudent` ENABLE KEYS */;

-- Dumping data for table db_wup.tblstudentnotif: ~13 rows (approximately)
/*!40000 ALTER TABLE `tblstudentnotif` DISABLE KEYS */;
INSERT IGNORE INTO `tblstudentnotif` (`NotificationID`, `IDNO`, `BLOGID`, `TYPE`) VALUES
	(26, '123123123', '', 'Event'),
...
INSERT IGNORE INTO `tblusers` (`USERID`, `NAME`, `UEMAIL`, `PASS`, `TYPE`) VALUES
